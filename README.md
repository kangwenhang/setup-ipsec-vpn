...
For other installation options and how to set up VPN clients, read the sections below. A pre-built [Docker image](https://github.com/hwdsl2/docker-ipsec-vpn-server) is also available.
